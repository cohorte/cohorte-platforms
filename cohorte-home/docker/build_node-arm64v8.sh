...
echo "scp -r -o StrictHostKeyChecking=no -i $ID_RSA $DIR/node-arm64v8 root@$DOCKER_ARM_HOST:/root/docker/runtime-arm64v8"
#scp -r -o StrictHostKeyChecking=no -i $ID_RSA $DIR/node-arm64v8 root@$DOCKER_ARM_HOST:/root/docker/runtime-arm64v8
