...
echo -e "\x1B[1;32m[INFO] Building Image [$DOCKER_REPOSITORY:$DOCKER_TAG] located on [$DIRECTORY]\x1B[0m"
echo "scp -r -o StrictHostKeyChecking=no -i $ID_RSA $DIR/demo-arm64v8 root@$DOCKER_ARM_HOST:/root/docker/runtime-arm64v8"
#scp -r -o StrictHostKeyChecking=no -i $ID_RSA $DIR/demo-arm64v8 root@$DOCKER_ARM_HOST:/root/docker/runtime-arm64v8
