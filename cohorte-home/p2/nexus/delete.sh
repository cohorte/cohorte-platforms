...
curl -v -X DELETE -u $user:$pass "https://nrm.cohorte.tech/service/rest/v1/script/$name"

printf "Uploading $name script. It contains: $jsonFile\n\n"

curl -v -u $user:$pass --header "Content-Type: application/json" 'https://nrm.cohorte.tech/service/rest/v1/script/' -d @$jsonFile
