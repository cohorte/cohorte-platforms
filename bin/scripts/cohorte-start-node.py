...
""".format(home=COHORTE_HOME, base=os.environ['COHORTE_BASE'],
  ...
  - You have to downgrade your python interpretor to a version between 3.4.0 and 3.5.0.\n""".format(vers=PYTHON_VERSION))
    ...
    # MOD_OG_20170404 - dump infos
    # Dump command
    msg4 = """  - Launch boot: {command}""".format(command=[PYTHON_INTERPRETER] + interpreter_args + boot_args)
    print(msg4)
    ...
    result_code = 0
    try:
        # call directly the main of the boot module
        result_code = boot.main(boot_args)
